        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?php echo base_url('public/back/#'); ?>">
                    <img src="<?php echo base_url('public/back/images/icon/logo.png'); ?>" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-06.jpg'); ?>" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-04.jpg'); ?>" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                            ...
                                            <div class="mess__footer">
                                                <a href="<?php echo base_url('public/back/#'); ?>">View all messages</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-06.jpg'); ?>" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-05.jpg'); ?>" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-04.jpg'); ?>" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__footer">
                                                <a href="<?php echo base_url('public/back/#'); ?>">See all emails</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="notifi-dropdown js-dropdown">
                                            ...
                                            <div class="notifi__footer">
                                                <a href="<?php echo base_url('public/back/#'); ?>">All notifications</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo base_url('public/back/images/icon/avatar-01.jpg'); ?>" alt="John Doe" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="<?php echo base_url('public/back/#'); ?>">john doe</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="<?php echo base_url('public/back/#'); ?>">
                                                        <img src="public/back/<?php echo base_url('public/back'); ?>images/icon/avatar-01.jpg" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="<?php echo base_url('public/back/#'); ?>">john doe</a>
                                                    </h5>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="<?php echo base_url('public/back/#'); ?>">Meeting about plan for Admin Template 2018</a>
                                                    </h5>
                                            ...
                                            <div class="au-task__item au-task__item--warning">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="<?php echo base_url('public/back/#'); ?>">Create new task for Dashboard</a>
                                                    </h5>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-02.jpg'); ?>" alt="John Smith">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-03.jpg'); ?>" alt="Nicholas Martinez">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-04.jpg'); ?>" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('public/back/images/icon/avatar-05.jpg'); ?>" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Michelle Sims</h5>
                                        ...
                                        <div class="au-chat">
                                            <div class="au-chat__title">
                                                <div class="au-chat-info">
                                                    ...
                                                    <span class="nick">
                                                        <a href="<?php echo base_url('public/back/#'); ?>">John Smith</a>
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2018 Colorlib. All rights reserved. Template by <a href="<?php echo base_url('public/back/https://colorlib.com'); ?>">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
